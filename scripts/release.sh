...
#      (standard/manifest.json), and the git tag v<version> must
...
# ── Standard identity ───────────────────────────────────────────────
STANDARD_ID="anvil-standard-flutter"
BINARY_NAME="anvil-adapter-flutter"
ADAPTER_DIR="cmd/flutter-adapter"
SOURCE_MANIFEST="${ROOT_DIR}/standard/manifest.json"
VALIDATOR="${ROOT_DIR}/scripts/validate-manifest.sh"
REPO="maleolabs/anvil-standard-flutter"
...
# manifest, lifecycle, verification, templates, compatibility, docs, tests,
# and the authored skills). The platform binaries are staged separately
# (see below).
ARCHIVE_PARTS=(
    "standard"
    "README.md"
...
Release of the Flutter delivery lifecycle standard, registry version
