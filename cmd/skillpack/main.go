...
import (
	...
	"maleolabs.com/anvil-standard-flutter/internal/skillpack"
)
...
func run() error {
	...
	standard := fs.String("standard", "", "the standard id the skills ship with (e.g. anvil-standard-flutter); becomes the bundle source and the provenance header source")
